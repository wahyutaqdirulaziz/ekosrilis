<div id="newsletter" class="section">
		...
		<!-- jQuery Plugins -->
		<script src="<?php echo base_url('assets/baru/');?>js/jquery.min.js"></script>
		<script src="<?php echo base_url('assets/baru/');?>js/bootstrap.min.js"></script>
		<script src="<?php echo base_url('assets/baru/');?>js/slick.min.js"></script>
		<script src="<?php echo base_url('assets/baru/');?>js/nouislider.min.js"></script>
		<script src="<?php echo base_url('assets/baru/');?>js/jquery.zoom.min.js"></script>
