...
<html lang="id">
	<head>
        ...
        ?>
		        ...
		        <meta name="description" content="<?= $penginapan->nama_kamar ?> harga mulai dari Rp. <?= number_format($penginapan->harga[0]->harga). ' ' . $penginapan->harga[0]->durasi ?>" />    				<meta property="og:url" content="<?= base_url($penginapan->jenis_kamar.'/'.$penginapan->slug) ?>" />
        ...
        <link rel="canonical" href="<?= base_url() ?>" />
 		...
 		<!-- Bootstrap -->
 		<link type="text/css" rel="stylesheet" href="<?php echo base_url('assets/baru/');?>css/bootstrap.css"/>
 		<!-- Slick -->
